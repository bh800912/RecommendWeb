...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "GVWpGQp70GFGp33g6QF306ILGmjKLeee";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//convert to JSON format and get the key we want.
		...
		if (!event.isNull(IMAGES)) {
			...
			for (int i = 0; i < images.length(); i++) {
				...
				if (!image.isNull(URL_STR)) {
					String image_url = image.getString(URL_STR);
					return image_url;
				}
			}
		}
